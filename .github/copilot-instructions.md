...
CRITICAL: Output ONLY the formatted data in the exact format specified in lines 19-28 above. Do not include any explanation, narrative, or additional text. No preamble. No closing remarks. Just the formatted output and nothing else.
